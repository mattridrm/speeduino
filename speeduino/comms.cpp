...
constexpr byte codeVersion[] PROGMEM = { SERIAL_RC_OK, 's','p','e','e','d','u','i','n','o',' ','2','0','2','4','0','2','-','R','e','a','l','D','a','s','h'} ; //Note no null terminator in array and statu variable at the start
